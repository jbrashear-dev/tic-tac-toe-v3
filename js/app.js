...
const playerO = 'url(img/o.svg)';
const playerX = 'url(img/x.svg)';
const boxes = $('.box');
const start = "<div class='screen screen-start' id='start'><header><h1>Tic Tac Toe</h1><a href='#' class='button'>Start game</a></header></div>";
const winO ="<div class='screen screen-win screen-win-one' id='finish'><header><h1>Tic Tac Toe</h1><p class='message'> Winner!!!</p>" +
"<a href='#' class='button'>New game</a></header></div>";
const winX = "<div class='screen screen-win screen-win-two' id='finish'><header><h1>Tic Tac Toe</h1><p class='message'> Winner!!!</p>" +
"<a href='#' class='button'>New game</a></header></div>";
const winT = "<div class='screen screen-win screen-win-tie' id='finish'><header><h1>Tic Tac Toe</h1><p class='message'>It's a Tie</p>" +
"<a href='#' class='button'>New game</a></header></div>";
let player = playerO;
let boxFilled = 'box-filled-1';
let turnCounter = 0;
...
//box selection as long as class = box on click
  $('li').on('click', function () {
    if($(this).attr('class') == ('box')) {
      ...
      //change boxFilled variable to other player
